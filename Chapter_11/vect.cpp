...
namespace VECTOR
{
    // 1 라디안 내의 각도를 계산하라(1 라디안에 대한 degree 값을 계산)
    const double Rad_to_deg = 45.0 / atan(1.0);
    // 반드시 약 57.2957795130823 값이 되어야함
    ...
    // form이 r이면 직각좌표로부터 백터를 구성한다.
    // form이 p이면 극 좌표로부터 백터를 구성
    ...
    void Vector::rect_mode()        // 직각 좌표모드로 설정한다.
    {
        mode = RECT;
    }
