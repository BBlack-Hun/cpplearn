// workermi.h -- 다중 상속을 사용하는 작업 클래스들
#ifndef WORKERMI_H_
#define WORKERMI_H_
...
{
    protected:
        enum {other, alto, contraalto, soprano, bass, baritone, tenor};
        enum {Vtypes = 7};
        void Data() const;
        void Get();
    private:
...
// 다중 상속
class SingingWaiter : virtual public Worker, public Singer, public Waiter
{
    protected:
        void Data() const;
        void Get();
